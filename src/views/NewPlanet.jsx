...
const NewPlanet = () => {
  ...
  const onClickPlanetCheck = useCallback(() => {
    ...
    // Deco
    formData.append("color", [planetColor, planetShade]);
    formData.append("ears", [planetEarsIdx, planetEarsColor]);
    formData.append("nose", [planetNoseIdx, planetNoseColor]);
    formData.append("pattern", "num2");
